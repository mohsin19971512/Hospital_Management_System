...
class CustomUserManager(UserManager):
    ...
    def create_user(self,first_name, last_name, email,phone_number,type, password=None):
        if not email:
...
class User(AbstractUser, Entity):
    ...
    type = models.CharField(max_length=100,choices=[("patient","patient"),("doctor","doctor"),("receptionist","receptionist")])
